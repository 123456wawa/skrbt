-- ==========================================
-- سكربت blokspin المطور | نظام المشي التلقائي للبقالة
-- الرمز السري: WAFI
-- ==========================================
...
if CoreGui:FindFirstChild("BlokSpinWalkGui") then
    CoreGui:FindFirstChild("BlokSpinWalkGui"):Destroy()
end

local ScreenGui = Instance.new("ScreenGui")
ScreenGui.Name = "BlokSpinWalkGui"
...
-- زر البقالة الذكي (المشي التلقائي)
...
GroceryButton.MouseButton1Click:Connect(function()
    ...
    if humanoid and hrp then
        ...
        -- أمر جعل اللاعب يمشي للموقع المطلوب
        local targetPos = Vector3.new(164.98, 254.74, 204.42)
        humanoid:MoveTo(targetPos)
        
        -- نظام انتظار حتى يصل اللاعب أو يتجاوز وقت محدد (حماية من التعليق)
        local reached = false
        local connection
        ...
        -- حماية إضافية: إذا مرّت 30 ثانية ولم يصل (بسبب جدار أو زحمة)، يكمل السكربت عمله
        ...
        -- انتظر حتى يصل اللاعب
        repeat task.wait() until reached
        
        GroceryButton.Text = "⚡ تم الوصول والعمل!"
        
        -- تفعيل زر التوظيف تلقائياً عند الوصول
        task.wait(0.5)
